function RadarChart(id, data) {
  const cfg = {
    ...
    color: d3.scale.ordinal().range(["#800080"])	//Color function
  };
  ...
  axisGrid.selectAll(".axisLabel")
    ...
    .attr("fill", "#737373")
    .text(function(d) { return Format(maxValue * d/3); });
...
const data = [
  [
    { axis:"BackEnd", value:0.8 },
    { axis:"DevOps", value:0.8 },
