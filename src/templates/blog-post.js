          ...
          {translations.length > 0 && (
            <span>
              {hasRussianTranslation && (
                <span>
                  Originally written in: {'en' === lang ? <b>{codeToLanguage('en')}</b> : <Link to={languageLink('en')}>English</Link>}
                  {' • '}
                  {'ru' === lang ? <b>Русский (авторский перевод)</b> : <Link to={languageLink('ru')}>Русский (авторский перевод)</Link>}
                  <br />
                  <br />
                </span>
              )}
